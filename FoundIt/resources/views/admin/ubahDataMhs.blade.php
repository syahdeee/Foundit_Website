...
<body>
    ...
    <header class="bg-white">
        <div class="mx-10 flex justify-between">
            ...
            <div class="flex justify-center items-center w-2/3">
                <h1 class="text-lg text-[#8D9EFF] font-mons font-bold uppercase ">Ubah Data User Mahasiswa</h1>
            </div>
    ...
    <section class="bg-[#F5F5F5] px-4 py-8">
        <div class="container">
            <div class="w-[60%] mx-auto border border-[#6C4AB6] rounded-2xl shadow-2xl">
                <form class="flex w-full">
                    <!-- Sisi kiri -->
                    <div class="w-1/2 py-4 px-4">
                        <!-- Nama Barang -->
                        <label class="text-xs text-[#244CA5] font-pop font-medium" for="nama-user"> Nama Mahasiswa </label>

                        <input class="w-full p-3 border border-[#88C6F8] rounded-xl shadow-md" type="text" id="nama-user">

                        <div class="w-full h-[60%]">
                            <!-- Input Image -->
                            <label class="mb-1 pt-2 text-xs text-[#244CA5] font-pop font-medium block">Upload KTM</label>
                                <label for="upload-ktm" class=" flex flex-col items-center justify-center w-[60%] h-[90%] border border-gray-100 rounded-xl shadow-3xl cursor-pointer bg-gray-50 ">
                                    ...
                                    <input id="upload-ktm" type="file" class="hidden" />
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="w-1/2 py-4 px-4">
                        <!-- Kategori Barang -->
                        <label class="text-xs text-[#244CA5] font-pop font-medium" for="kategori"> NIM </label>

                        <input class="w-full p-3 border border-[#88C6F8] rounded-xl shadow-md" type="text" id="kategori">

                        <!-- Deskripsi Barang -->
                        <label class="text-xs text-[#244CA5] font-pop font-medium" for="email"> Email/No. Telepon </label>

                        <input class="w-full p-3 border border-[#88C6F8] rounded-xl shadow-md" type="text" id="email">

                        <!-- Jurusan  -->
                        <label class="text-xs text-[#244CA5] font-pop font-medium" for="jurusan"> Jurusan </label>

                        <input class="w-full p-3 border border-[#88C6F8] rounded-xl shadow-md" type="text" id="jurusan">
                    </div>
                </form>
            </div>
        </div>
